...
void CPropertyDlg::initPageFrame()
{
	...
	// OullineView Font
	::lstrcpy(pFrame->lfOutline.lfFaceName, AfxGetApp()->GetProfileString(REGS_FRAME, _T("Font1 Name"), _T("ＭＳ Ｐゴシック")));
	...
	// LinkView Font
	::lstrcpy(pFrame->lfLink.lfFaceName, AfxGetApp()->GetProfileString(REGS_FRAME, _T("Font2 Name"), _T("ＭＳ Ｐゴシック")));
	...
	// TextView Font
	::lstrcpy(pFrame->lfText.lfFaceName, AfxGetApp()->GetProfileString(REGS_FRAME, _T("Font3 Name"), _T("ＭＳ ゴシック")));
